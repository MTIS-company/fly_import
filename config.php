<?
  ...
  const SECTION = 6146; // id корневого раздела для данного каталога товаров localhost
  // const SECTION = 322; // id корневого раздела для данного каталога товаров test.navi
